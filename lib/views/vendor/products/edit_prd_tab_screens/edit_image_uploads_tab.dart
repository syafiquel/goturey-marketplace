...
import 'package:goturey_marketplace/resources/assets_manager.dart';
...
class _EditImageUploadTabState extends State<EditImageUploadTab>
  ...
  isLoadingFnc() {
    ...
    Timer(const Duration(seconds: 2), () {
      kCoolAlert(
        ...
        action: (_) => completeSuccessAction(),
      );
    });
  }
    ...
    Future<void> submitProduct() async {
      ...
      if (result.success == null) {
        kCoolAlert(
          ...
          action: (_) => completeFailureAction(),
        );
      } else {
